...
def sift_unique(passage):
    ...
    #iterate through set and append any valid word to a new set
    for word in passage:
        if word.isalpha():
...
NEWS_PASSAGE1 = remove_punctuation(NEWS_PASSAGE1)
NEWS_PASSAGE2 = remove_punctuation(NEWS_PASSAGE2)

# split each passage into a list of words
NEWS_PASSAGE1 = split_passage(NEWS_PASSAGE1)
NEWS_PASSAGE2 = split_passage(NEWS_PASSAGE2)
...
NEWS_PASSAGE1 = sift_unique(NEWS_PASSAGE1)
...
NEWS_PASSAGE2 = sift_unique(NEWS_PASSAGE2)

# create a set of words that are in both passage 1 and passage 2
COMMON_WORDS = NEWS_PASSAGE1.intersection(NEWS_PASSAGE2)
