...
def split_group_line(line):
    '''
    Parametrs: line - a single line from /etc/group file
    Returns: a list of group data
    '''

def parse_groups(file_path='/etc/group'):
    '''
    Parametrs: file path (string) with a default of (`/etc/group)
    Returns: nested list of field seperated group data
    Use list comprehension and split_group_line
    '''
...
def get_user_accounts(passwd_file='/etc/passwd'):
    ...
    Use filter and above is_user_account
    '''
